...
const calcBodyClass = "max-w-lg rounded overflow-hidden shadow-2xl bg-pink-700 bg-opacity-75 bg-gradient-to-tr from-blue-800 flex";
...
function addClasses(button) {
    ...
    const btnClearClass = "hover:orange-red-500 border-orange-500";
    const btnOpClass = "hover:bg-blue-500 border-blue-500";
    const btnDecClass = "hover:bg-red-500 border-red-500";
    const btnEqClass = "hover:bg-yellow-500 border-yellow-500";
